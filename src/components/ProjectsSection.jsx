...
const projects = [
    ...
    },
    {
        ...
        description: 'Interactive analytics dashboard with data visualization and filtering capabailities',
    ...
    <section id='projects' className='py-24 px-4 relative'>
        <div className='container mx-auto max-w-5xl'>
            ...
            <div className='text-center mt-12'>
                <a className='cosmic-button w-fit flex items-center mx-auto gap-2' href='https://github.com/Dhanyaja'
                    target='_blank'>
