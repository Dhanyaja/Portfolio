        ...
        <div className='container mx-auto max-w-5xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
                ...
                <p className='text-mued-foreground'>
                  I'm a passionate frontend developer with strong skills in React, JavaScript, and modern web technologies, dedicated to crafting clean, responsive, and user-friendly interfaces that deliver great user experiences.
                </p>
